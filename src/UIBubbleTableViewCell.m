...
//    }
    ...
    {
        self.bubbleImage.image = [[UIImage imageNamed:@"bubbleSomeone"] stretchableImageWithLeftCapWidth:15 topCapHeight:14];
         self.bubbleImage.frame = CGRectMake(x, y, width + self.data.insets.left + self.data.insets.right-7, height + self.data.insets.top + self.data.insets.bottom);
