...
#define kPostStatusMethodValue              @"postStatus"
#define kGetPostMessagesValue               @"getPostMessages"
#define kCheckInUserValue                   @"checkedIn"
#define kLogInMethodValue                   @"login"
#define kSinUpMethodValue                   @"signUp"
#define kLikeMethodValue                    @"like"
#define kEditUserProfileValue               @"editProfile"
#define kGetCheckinUsersValue               @"getCheck"
#define kSetCriteriaValue                   @"setCategory"
#define kGetCurrentUserCheckinDetailValue   @"getCheckindata"
#define kSendMessageValue                   @"sendMessages"
#define kGetAllLatestMessagesValue          @"getAllMessages"
#define kGetAllMessagesValue                @"getMessages"
#define kGetOtherUserDetailsValue           @"otherUserDetails"
#define kSearchnearByLocationValue          @"searchLocation"
#define kMessageCountValue                  @"countUsers"
#define kEditTagLineValue                   @"editTagline"
#define kEditGenderValue                    @"editGender"
#define kEditGenderTypeValue                @"editGenderType"
#define kEditRadiusValue                    @"editRadius"
#define kDeleteImageValue                   @"deleteImage"
#define kGetCountOfUsersValue               @"countCheckUser"
#define kDeleteUserMethodValue              @"deleteAccount"
#define kBlockUserMethodValue               @"blockUsers"
#define kEditAgeValue                       @"editAge"
...
#define kDeviceTokenParam           @"deviceid"
#define kUserIDParam                @"userid"
#define kUserFacebookIDParam        @"userfacebookid"
#define kTagLineParam               @"tagline"
#define kAuthKeyParam               @"auth_key"
#define kMessageParam               @"msg"
#define kLatitudeParam              @"lat"
#define kLongitudeParam             @"lon"
#define kAddressParam               @"address"
#define kPostImageParam             @"locationimg"
#define kPostIDParam                @"postid"
#define kImageParam                 @"image"
#define kTimeZoneParam              @"timezone"
#define kRadiusParam                @"radius"
#define kMinimumAgeParam            @"minage"
#define kMaximumAgeParam            @"maxage"
#define kGenderParam                @"gender"
#define kGenderTypeParam            @"gendertype"
#define kPageParam                  @"page"
#define kOtherUserIDParam           @"otheruserid"
#define kFriendsIDParam             @"friendid"
#define kInterestIDParam            @"interestid"
#define kFourSquareIDParam          @"foursquareid"
#define kAgeParam                  @"age"
#define kCheckInImageParam          @"checkinimage"
#define kCheckinFeedImageParam      @"checkin_feeds"
#define kFullAdressParam            @"fulladdress"
#define kPhoneParam                 @"phone"
#define kIconImageParam             @"image"
#define kPlaceNameParam             @"placename"
#define kLocationTypeParam          @"locationtype"
