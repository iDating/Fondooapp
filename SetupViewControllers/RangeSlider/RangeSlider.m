...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _trackBackground = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"bar-background"]] ;
        _trackBackground.center = self.center;
        [self addSubview:_trackBackground];
        
        _track = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"bar-highlight"]];
        _track.center = self.center;
        [self addSubview:_track];
        
        _minThumb = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"handle"] highlightedImage:[UIImage imageNamed:@"handle-hover"]];
        ...
        _maxThumb = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"handle"] highlightedImage:[UIImage imageNamed:@"handle-hover"]];
...
- (CGPoint) minPos
{
    return CGPointMake([self xForValue:selectedMinimumValue], self.center.y);
}

- (CGPoint) maxPos
{
    return CGPointMake([self xForValue:selectedMaximumValue], self.center.y);
}
